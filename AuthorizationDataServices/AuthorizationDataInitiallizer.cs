    ...
    public class AuthorizationDataInitiallizer
    {
        ...
        private static void InitBusinessResources(AuthorizationDataModel db)
        {
            ...
            if (db.Roles.Count() < 3)
            {
                ...
                db.Roles.Add(users = new BusinessResource()
                {
                    Name = "Личный кабинет",
                    Code = "User",
                    Description = "Базовый полномочия, которые распостраняются на всех сотрудников"
                });
                db.Roles.Add(analitics = new BusinessResource()
                {
                ...
                db.Roles.Add(admins = new BusinessResource()
                {
                ...
                db.Roles.Add(new BusinessResource()
                {
                    Name = "Разработка",
                    Code = "Developer",
